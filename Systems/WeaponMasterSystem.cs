            ...
            if (isMastered)
            {
                switch (WeaponType)
                {
                    ...
                    case WeaponType.Spear:
                        {
                            ModifyUnitStatBuff_DOTS modifyUnitStatBuff_DOTS = default(ModifyUnitStatBuff_DOTS);
                            modifyUnitStatBuff_DOTS.StatType = (UnitStatType)42;
                            modifyUnitStatBuff_DOTS.Value = (float)(PMastery * 0.0015);
                            modifyUnitStatBuff_DOTS.ModificationType = (ModificationType)3;
                            modifyUnitStatBuff_DOTS.Id = ModificationId.NewId(0);
                            Buffer.Add(modifyUnitStatBuff_DOTS);
                            modifyUnitStatBuff_DOTS = default(ModifyUnitStatBuff_DOTS);
                            modifyUnitStatBuff_DOTS.StatType = 0;
                            modifyUnitStatBuff_DOTS.Value = (float)(PMastery * 0.25);
                            modifyUnitStatBuff_DOTS.ModificationType = (ModificationType)3;
                            modifyUnitStatBuff_DOTS.Id = ModificationId.NewId(0);
                            Buffer.Add(modifyUnitStatBuff_DOTS);
                            modifyUnitStatBuff_DOTS = default(ModifyUnitStatBuff_DOTS);
                            modifyUnitStatBuff_DOTS.StatType = (UnitStatType)29;
                            modifyUnitStatBuff_DOTS.Value = (float)(PMastery * 0.001);
                            modifyUnitStatBuff_DOTS.ModificationType = (ModificationType)3;
                            modifyUnitStatBuff_DOTS.Id = ModificationId.NewId(0);
                            Buffer.Add(modifyUnitStatBuff_DOTS);
                            modifyUnitStatBuff_DOTS = default(ModifyUnitStatBuff_DOTS);
                            modifyUnitStatBuff_DOTS.StatType = (UnitStatType)30;
                            modifyUnitStatBuff_DOTS.Value = (float)(PMastery * 0.0025);
                            modifyUnitStatBuff_DOTS.ModificationType = (ModificationType)3;
                            modifyUnitStatBuff_DOTS.Id = ModificationId.NewId(0);
                            Buffer.Add(modifyUnitStatBuff_DOTS);
                            modifyUnitStatBuff_DOTS = default(ModifyUnitStatBuff_DOTS);
                            modifyUnitStatBuff_DOTS.StatType = (UnitStatType)4;
                            modifyUnitStatBuff_DOTS.Value = (float)(PMastery * 3.0);
                            modifyUnitStatBuff_DOTS.ModificationType = (ModificationType)3;
                            modifyUnitStatBuff_DOTS.Id = ModificationId.NewId(0);
                            Buffer.Add(modifyUnitStatBuff_DOTS);
                            modifyUnitStatBuff_DOTS = default(ModifyUnitStatBuff_DOTS);
                            modifyUnitStatBuff_DOTS.StatType = (UnitStatType)59;
                            modifyUnitStatBuff_DOTS.Value = (float)(PMastery * 0.0015);
                            modifyUnitStatBuff_DOTS.ModificationType = (ModificationType)3;
                            modifyUnitStatBuff_DOTS.Id = ModificationId.NewId(0);
                            Buffer.Add(modifyUnitStatBuff_DOTS);
                            modifyUnitStatBuff_DOTS = default(ModifyUnitStatBuff_DOTS);
                            modifyUnitStatBuff_DOTS.StatType = (UnitStatType)7;
                            modifyUnitStatBuff_DOTS.Value = (float)(1.0 - (double)PMastery * 0.01 * 0.025);
                            modifyUnitStatBuff_DOTS.ModificationType = 0;
                            modifyUnitStatBuff_DOTS.Id = ModificationId.NewId(0);
                            Buffer.Add(modifyUnitStatBuff_DOTS);
                            return;
                        }
